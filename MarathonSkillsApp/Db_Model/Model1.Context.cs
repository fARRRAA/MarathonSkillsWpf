...
namespace MarathonSkillsApp.DB_model
{
    ...
    public partial class mrthnskillsEntities : DbContext
    {
        public mrthnskillsEntities()
            : base("name=mrthnskillsEntities")
        {
        }
        ...
        public virtual DbSet<KitContents> KitContents { get; set; }
        public virtual DbSet<KitTypes> KitTypes { get; set; }
